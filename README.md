...
The model (sometimes referred to as the Q-learning model in other publications)'s decision is guided by two decision variables, associated with two choices given to the animals. In our case, $Q_l$ corresponds to leftward choices, while $Q_r$ corresponds to the right.
