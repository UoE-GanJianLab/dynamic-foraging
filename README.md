...
$$
P_r=\frac{e^{\beta\cdot Q_r}}{e^{\beta\cdot Q_r}+e^{\beta\cdot Q_l+b}}\\=\frac{1}{1+e^{-\beta(Q_r-Q_l)+b}}
$$
...
$$
\delta=r-Q_{choice}\\Q_{choice}=Q_{choice}+\alpha\cdot\delta\\Q_{non-choice}=Q_{non-choice}
$$
