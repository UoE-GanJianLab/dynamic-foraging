...
figure_4_data_source = pjoin('figure_data', 'figure_4')
figure_4_panel_abcd_pfc_data_top = pjoin(figure_4_data_source, 'figure_4_panel_abcd_pfc_top')
figure_4_panel_abcd_dms_data_top = pjoin(figure_4_data_source, 'figure_4_panel_abcd_dms_top')
figure_4_panel_abcd_pfc_data_bottom = pjoin(figure_4_data_source, 'figure_4_panel_abcd_pfc_bottom')
figure_4_panel_abcd_dms_data_bottom = pjoin(figure_4_data_source, 'figure_4_panel_abcd_dms_bottom')

figure_4_figure_root = pjoin('figures', 'all_figures', 'figure_4')
...
figure_4_figure_root = pjoin('figures', 'all_figures', 'figure_4')
figure_4_panel_abcd_figure_root = pjoin(figure_4_figure_root, 'panel_abcd')
figure_4_panel_abcd_pfc_root = pjoin(figure_4_panel_abcd_figure_root, 'pfc')
figure_4_panel_abcd_dms_root = pjoin(figure_4_panel_abcd_figure_root, 'dms')

for dir in [figure_4_figure_root, figure_4_panel_abcd_figure_root, figure_4_panel_abcd_pfc_root, figure_4_panel_abcd_dms_root, figure_4_data_source, figure_4_panel_abcd_pfc_data_top, figure_4_panel_abcd_dms_data_top, figure_4_panel_abcd_pfc_data_bottom, figure_4_panel_abcd_dms_data_bottom]:
    if not isdir(dir):
        mkdir(dir)
...
def raster(spikes, cue_times, leftP, session_name, brain_section):
    for ind in range(len(spikes)):
        ...
        if brain_section == 'pfc':
            fig.savefig(pjoin(figure_4_panel_abcd_pfc_root, fig_name), dpi=100)
        else:
            fig.savefig(pjoin(figure_4_panel_abcd_dms_root, fig_name), dpi=100)
        ...
        if brain_section == 'pfc':
            figure_4_panel_abcd_pfc_data_top_path = pjoin(figure_4_panel_abcd_pfc_data_top, data_file_name)
            raster_data.to_csv(figure_4_panel_abcd_pfc_data_top_path, index=False)
        else:
            figure_4_panel_abcd_dms_data_top_path = pjoin(figure_4_panel_abcd_dms_data_top, data_file_name)
            raster_data.to_csv(figure_4_panel_abcd_dms_data_top_path, index=False)
        ...
        if brain_section == 'pfc':
            figure_4_panel_abcd_pfc_data_bottom_path = pjoin(figure_4_panel_abcd_pfc_data_bottom, data_file_name)
            line_data.to_csv(figure_4_panel_abcd_pfc_data_bottom_path, index=False)
        else:
            figure_4_panel_abcd_dms_data_bottom_path = pjoin(figure_4_panel_abcd_dms_data_bottom, data_file_name)
            line_data.to_csv(figure_4_panel_abcd_dms_data_bottom_path, index=False)

def get_figure_4_panel_abcd():
...
def get_figure_4_panel_ef_left(prpd=True):
    if prpd:
    ...
    if prpd:
        panel_e_data.to_csv(pjoin(figure_4_data_root, 'figure_4_panel_ef_left_prpd.csv'), index=False) 
    else:
        panel_e_data.to_csv(pjoin(figure_4_data_root, 'figure_4_panel_ef_left_relative_value.csv'), index=False)
...
def get_figure_4_panel_ef_right(prpd=True):
    if prpd:
        correlation_data = pd.read_csv(pjoin('data', 'prpd_correlation.csv'))
    else:
        correlation_data = pd.read_csv(pjoin('data', 'relative_value_correlation.csv'))
    ...
    if prpd:
        panel_ef_right_data.to_csv(pjoin(figure_4_data_root, 'figure_4_panel_ef_right_prpd.csv'), index=False)
    else:
        panel_ef_right_data.to_csv(pjoin(figure_4_data_root, 'figure_4_panel_ef_right_relative_value.csv'), index=False)
...
def get_figure_4_panel_gh():
    ...
    df.to_csv(pjoin(figure_4_data_root, 'figure_4_panel_gh.csv'), index=False)
